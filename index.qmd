...
- Les rôles traditionnels sont le plus souvent occupés par des actuaires (parfois des Fellows), tandis que les rôles non-traditionnels peuvent être occupés par des actuaires, mais surtout par des scientifiques de donnnées, des programmeurs, etc.
...
- Par rapport au département d'actuariat, je pense qu'on fait plus de programmation, entre autres.
:::
...
## Exemples de projets --- Autres projets
